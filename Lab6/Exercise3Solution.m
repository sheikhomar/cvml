...
% There is one feature vector per pixel. Each feature vector is
% 4-dimensional and represents the response of each of the 4 directional
% filters.
...
% Display texton map:
% Pixel intensities correspond to cluster indexes (range: 1 to numClusters)
